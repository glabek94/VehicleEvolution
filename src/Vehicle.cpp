...
void Vehicle::createBody(float leftWheelSize, float rightWheelSize, float x_, float y_)
{
    ...
    leftWheelBody = World::getInstance().createDynamicBody(x_ / SCALE + vertices[0].first,
                                                           y_ / SCALE + vertices[0].second);
    ...
    rightWheelBody = World::getInstance().createDynamicBody(x_ / SCALE + vertices[2].first,
                                                            y_ / SCALE + vertices[2].second);
...
/*
    ...
    for (auto const& wheel:wheelSizes)
    {
        ...
        wheelShapes[i].setFillColor(sf::Color::Green);
